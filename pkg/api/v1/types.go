...
type Taint struct {
	...
	// Valid effects are NoSchedule, PreferNoSchedule, and NoScheduleNoAdmit.
...
type Toleration struct {
	...
	// When specified, allowed values are NoSchedule, PreferNoSchedule and NoScheduleNoAdmit.
